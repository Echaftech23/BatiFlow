...
import { LightBrandLogo } from "@/components/logo/Light";
...
export default function LoginScreen() {
  ...
  const onSubmit = async (values: LoginFormValues) => {
    ...
    try {
      ...
      router.replace("/(app)/(tabs)/rendez-vous");
    } catch (e) {
  ...
  return (
    <View className="relative h-full bg-white">
      ...
      <View className="flex-1 flex-col justify-between gap-36">
        ...
        <View
          className="relative flex overflow-hidden px-7 pb-5"
        ...
        >
          <ScrollView
            className="flex-1"
            contentContainerClassName="px-screen-x pb-10 pt-1"
          ...
          >
            ...
            <Link href="/(auth)/forgot-password" asChild>
              <Pressable className="mt-3 self-end">
                <Text className="text-badge font-medium text-[#525252]">
                  Mot de passe oublie ?
                </Text>
              </Pressable>
            </Link>
            ...
            <Link href="/(auth)/register" asChild>
              <Pressable className="mt-8">
                <Text className="text-center text-badge text-muted-foreground">
                  ...
                  <Text className="text-badge font-medium text-navy">
                    Creer un compte
                  </Text>
                </Text>
              </Pressable>
