  ...
  return (
    ...
    >
      <View className="mt-5 rounded-[24px] border border-[#D1D5DB] bg-white px-5 pb-7 pt-8">
        <View className="items-center">
          <View className="h-20 w-20 items-center justify-center rounded-2xl bg-[#FCE9DB]">
            <Image source={lockImage} className="w-8 h-8" resizeMode="contain" />
          </View>
          <Text className="mt-5 text-[#525252] font-quicksand font-bold text-[20px] leading-none text-center">
            Conditions d&apos;utilisation
          </Text>
          <Text className="mt-4 px-6 text-[#52525B] font-normal text-[14px] leading-[20px] text-center">
        ...
        <View className="mt-6 flex-row items-center">
          <View className="h-7 w-7 items-center justify-center rounded-md bg-[#E5E7EB]">
            <Text className="font-sans-semibold text-[12px] text-[#525252]">1</Text>
          </View>
          <Text className="ml-3 font-sans-semibold text-[16px] text-[#525252]">
            Objet du Service
          </Text>
        </View>

        <Text className="mt-4 pb-14 text-body text-[#737373] font-light leading-[20px] tracking-[0px] flex items-center">
          Le présent document définit conditions dans lesquelles l&apos;entreprise Atelier
          fournit ses services aux artisans. En utilisant notre plateforme, vous
          acceptez de respecter ces termes sans réserve. se réserve le droit de
          modifier ces termes à tout moment pour s&apos;adapter aux évolutions
          législatives.
        </Text>
      </View>
      ...
      >
        ...
        <Text className="ml-3 flex-1 font-normal text-[12px] leading-[18px] text-[#52525B]">
      ...
      <PrimaryButton
        ...
        className="mt-12 mb-10 rounded-pill bg-primary py-4 disabled:opacity-60"
