...
export default function RoiScreen() {
  ...
  return (
    <View className="flex-1 bg-background">
      ...
      >
        <Text className="font-sans-bold text-title text-navy">ROI</Text>
      ...
      <View className="flex-1 items-center justify-center px-screen-x">
        <View className="max-w-sm rounded-card border border-dashed border-border bg-surface p-8">
          <Text className="text-center font-sans-bold text-subtitle text-navy">
            Analyse ROI
          </Text>
          <Text className="font-sans mt-3 text-center text-body text-muted-foreground">
            Suivi des retours sur investissement — écran placeholder pour conserver la barre
            d’onglets comme sur le design.
          </Text>
        </View>
      </View>
    </View>
