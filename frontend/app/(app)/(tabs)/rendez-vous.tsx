<<<<<<< Updated upstream
export { default } from '../../../components/appointments/RendezVousScreen';
=======
  ...
  return (
    <View className="flex-1 bg-background">
      ...
      <View className="mt-8 px-screen-x">
        ...
        <View className="mt-4 rounded-full border border-[#E5E5E5] bg-[#F1F5F9] p-1">
      ...
      {viewMode === "list" ? (
        ...
        <ScrollView
          className="flex-1 px-screen-x pb-28 pt-5"
          refreshControl={
            <RefreshControl
              refreshing={isRefetching}
              onRefresh={refetch}
      ...
      <Pressable
        ...
        className="absolute right-4 h-[70px] w-[70px] items-center justify-center rounded-full bg-primary bottom-4"
      >
